...
func parseConfig(logger *zap.Logger) config {
	...
	var (
		...
		streamURLaddr        = flag.String("streamURLaddr", "https://deflix-egd-stremio.herokuapp.com/:5000", "Address to be used in a stream URL that's delivered to Stremio and later used to redirect to , AllDebrid and Premiumize. If you enable OAuth2 handling this will also be used to determine whether the state cookie is a secure one or not.")
